...
<div class="wpr-panel">
	...
	<table class="form-table" role="presentation"><tbody>
		<tr><th scope="row"><label for="wprt_dark_mode"><?php esc_html_e( 'Day / Night mode', 'wpraffle-theme' ); ?></label></th>
			<td><select id="wprt_dark_mode" name="wpr_settings[dark_mode]">
				...
				<p class="description"><?php esc_html_e( 'Uses a preset-matched day/night switch and coordinated colours across the theme, WPRaffle components and WooCommerce.', 'wpraffle-theme' ); ?></p></td></tr>
