...
<div class="swiper-slide">
	<div class="diamond-winner-card">
		...
		<div class="diamond-winner-card__body">
			<h3 class="diamond-winner-card__name"><?php esc_html_e( 'Your Winner Here', 'wpraffle-theme' ); ?></h3>
			<p class="diamond-winner-card__prize"><?php esc_html_e( 'Activate WPRaffles to showcase recent winners.', 'wpraffle-theme' ); ?></p>
		</div>
	</div>
</div>
